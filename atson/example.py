...
demo_text = 'AlchemyAPI provides advanced text analysis capabilities through a REST API. This allows you to transform your unstructured content from sources like blog posts, news articles, product reviews, forums and social media posts into structured data. With '
demo_url = 'http://www.alchemyapi.com/developers/getting-started-guide/using-alchemyapi-with-python#config-sdk'
demo_html = '<html><head>  <title>Getting Started with AlchemyAPI Using Python | AlchemyAPI</title></head></html>'
image_url = 'http://www.alchemyapi.com/sites/default/files/github-python-repo.png'
